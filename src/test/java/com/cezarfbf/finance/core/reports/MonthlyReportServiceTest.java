...
class MonthlyReportServiceTest {
    ...
    void getMonthlyReportCountsUnclassifiedAndTotalProcessed() {
        ...
        when(repository.findByDateGreaterThanEqualAndDateLessThanAndDeletedAtIsNullOrderByDateDesc(any(), any()))
            .thenReturn(txs);
    ...
    private static Transaction tx(String categoryName, String amount) {
